...
internal static class MissionControlEnvironmentExtensions
{
    ...
    {
        [MissionControlEnvironment.Sandbox] = ("https://api.sandbox.missioncontrol.io/partnerApi/v2", "api://38fbfaea-5648-4b51-ac09-d5d90117beff/.default"),
        [MissionControlEnvironment.Production] = ("https://api.missioncontrol.io/partnerApi/v2", "api://1b6f40bc-e051-4b7e-987f-47a4a19fa5ef/.default"),
    };
